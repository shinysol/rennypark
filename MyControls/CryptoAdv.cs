...
namespace MyControls
{
    public class CryptoAdv
    {
        ...
        private string sKey;
        private string vKey;
        public CryptoAdv(string PasswordHash, string SaltKey, string VIKey)
        {
            pHash = PasswordHash;
            sKey = SaltKey;
            vKey = VIKey;
        ...
        public string Encrypt(string plainText)
        {
            ...
            byte[] keyBytes = new Rfc2898DeriveBytes(pHash, Encoding.ASCII.GetBytes(sKey)).GetBytes(256 / 8);
